...
export default function SplendidRivalrySceneDraft1() {
  ...
  return (
    ...
    >
      ...
      <BoardDyanmic size={[6, 2]} color="#1e463b" position={[-2.75, -0.01, 3.5]} />
      ...
      <Card position={[-5, 0.05, 3.5]} />
      <Card position={[-4, 0.05, 3.5]} />
      <Card position={[-3, 0.05, 3.5]} />
      <Card position={[-2, 0.05, 3.5]} /> 
      <Card position={[-1, 0.05, 3.5]} />

      <Card position={[0.85+0.475, 0.05, 3.125]} size={[1.2, 0.01, 0.8]} />
      <Card position={[0.85+1.2+0.475+0.475, 0.05, 3.125]} size={[1.2, 0.01, 0.8]} />
      <Card position={[0.85+2.4+0.475+0.475+0.475, 0.05, 3.125]} size={[1.2, 0.01, 0.8]} />


      <Coin position={[0.5+0.25, 0.08, 4.125]} color="#000000" />
      <Coin position={[1+0.25*2, 0.08, 4.125]} color="#f8fafc" />
      <Coin position={[1.5+0.25*3, 0.08, 4.125]} color="#ef4444" />
      <Coin position={[2+0.25*4, 0.08, 4.125]} color="#3b82f6" />
      <Coin position={[2.5+0.25*5, 0.08, 4.125]} color="#22c55e" />
      <Coin position={[3+0.25*6, 0.08, 4.125]} color="#f086af" />
      <Coin position={[3.5+0.25*7, 0.08, 4.125]} color="#f7c335" />

      <GemBoard position={[-3.75, 0.05, -0.5]} color="#9b9b9b" />
